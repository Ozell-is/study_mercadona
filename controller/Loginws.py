...
from flask_jwt_extended import create_access_token,jwt_required,get_jwt_identity, create_refresh_token, set_access_cookies, set_refresh_cookies,verify_jwt_in_request
...
def authenticator():
    ...
    if admin:
        if check_password(hashed_password, password):
            ...
            redirect_response = make_response(redirect(url_for('productWs.get_admin_page')))
